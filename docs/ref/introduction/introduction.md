...
Next, refer to the following section for more detailed information:

- [Compatibility](compatibility.md): Supported Wazuh versions, platforms, and Ansible compatibility.
